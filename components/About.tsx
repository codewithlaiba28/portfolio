                    ...
                    <div className="lg:w-7/12">
                        <ScrollAnimation>
                            ...
                            <p className="text-text-secondary text-lg mb-10 leading-relaxed">
                                I am a passionate developer and AI enthusiast based in Karachi, Pakistan. With
                                hands-on experience in HTML5, CSS3, Tailwind CSS, React.js, TypeScript, and
                                Next.js, I specialize in building clean, responsive, and performant web
                                applications. My deep interest in Agentic AI, automation, and OpenAI SDK
                                integrations drives me to create intelligent, future-ready solutions. I believe
                                in writing code that not only works but inspires.
                            </p>
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    link.href = '/resume/Laiba_Khan_Resume.pdf';
                                    link.download = 'Laiba_Khan_Resume.pdf';
