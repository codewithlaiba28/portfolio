...
const Contact: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const templateParams = {
            ...
            to_name: "Laiba Khan", // Adding to_name as a best practice
        };
                        ...
                        <ScrollAnimation>
                            ...
                            <div className="space-y-8 mb-12">
                                <div className="flex items-center space-x-6 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-medium">laibakhan.web@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-6 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-medium">Karachi, Sindh, Pakistan</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a
                                    ...
                                    title="Instagram"
                                >
                                    <svg className="w-5 h-5 text-text-secondary group-hover:text-accent-primary transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
