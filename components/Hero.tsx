            ...
            <div className="container mx-auto px-6 text-center z-10">
                ...
                <ScrollAnimation delay={400}>
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-extrabold tracking-tight mb-6">
                        Hi, I&apos;m <span className="text-gradient">Laiba Khan</span>
                    </h1>
                </ScrollAnimation>
                ...
                <ScrollAnimation delay={800}>
                    <p className="text-text-secondary md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
                        I craft modern, AI-driven web applications using Next.js, React, and TypeScript.
                        Passionate about Agentic AI, automation, and architecting scalable solutions with OpenAI SDK.
                    </p>
                </ScrollAnimation>
                ...
                <ScrollAnimation delay={1000}>
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                        ...
                        <a
                            href="/resume/Laiba_Khan_Resume.pdf"
                            download="Laiba_Khan_Resume.pdf"
